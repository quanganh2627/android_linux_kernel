...
enum {
	...
	INTEL_MRFLPLUS_PHONE   = 0x000C,
	INTEL_MRFLPLUS_TABLET  = 0x000D,
...
/* Product_Line_ID table for Platform_Family_ID == IINTEL_MRFLPLUS_PHONE */
enum {
	INTEL_MRFLPLUS_PHONE_MP_PRO = 0x0000,
	INTEL_MRFLPLUS_PHONE_MP_ENG = 0x8000,
	INTEL_MRFLPLUS_PHONE_UNKNOWN = 0xFFFF
};

/* Product_Line_ID table for Platform_Family_ID == INTEL_MRFLPLUS_TABLET */
enum {
	INTEL_MRFLPLUS_TABLET_TBD_PRO = 0x0000,
	INTEL_MRFLPLUS_TABLET_TBD_ENG = 0x8000,
	INTEL_MRFLPLUS_TABLET_UNKNOWN = 0xFFFF
	};
...
/* Hardware_ID table for Product_Line_ID == INTEL_MRFLPLUS_PHONE_FRCB */
enum {
	MRFLPLUS_PHONE_MP_PRH0, /* FAB A */
	MRFLPLUS_PHONE_MP_PRH1, /* FAB B */
	MRFLPLUS_PHONE_MP_RSVD,
	MRFLPLUS_PHONE_MP_UNKNOWN = 0xFFFF
};

/* Hardware_ID table for Product_Line_ID == INTEL_MRFLPLUS_TABLET_TBD */
enum {
	MRFLPLUS_TABLET_TBD_TBD,
	MRFLPLUS_TABLET_TBD_RSVD,
	MRFLPLUS_TABLET_TBD_UNKNOWN = 0xFFFF
};
