...
#define SST_SHIM_END		SST_TMRCTL
#define SST_SHIM_SIZE		0xC8
...
struct intel_sst_drv {
	...
	struct workqueue_struct *recovery_wq; /*to queue work once recoevry is triggered*/
...
void sst_do_recovery_mofd(struct intel_sst_drv *sst);
